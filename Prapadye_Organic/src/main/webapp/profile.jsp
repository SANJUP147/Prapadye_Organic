...
<nav class="navbar navbar-expand-lg navbar-dark primary-background text-white">
  <a class="navbar-brand" href="index.jsp"><span class="fa fa-asterisk"></span>Prapadye Organic</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item primary-background text-white" href="cow_milk.jsp">Prapadye Organic Cow-Milk</a>
          <a class="dropdown-item primary-background text-white" href="buffalo_milk.jsp">Prapadye Organic Buffalo-Milk</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item primary-background text-white" href="varmi_compost.jsp">Prapadye Organic Varmi-Compost</a>
           
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link contact.jsp"><span class="fa fa-address-card"></span>About</a>
      </li>
      <li class="nav-item">
    ...
    <div class="modal fade" id="profile-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <h5 class="modal-title" id="exampleModalLabel"> Prapadye Organic </h5>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="add-post-form" action="AddPostServlet" method="post">
                            ...
                            <div class="form-group">
                                <textarea name="pBreed" class="form-control" style="height: 200px;" placeholder="Enter breed (if any)"></textarea>
                            </div>
                            <div class="form-group">
